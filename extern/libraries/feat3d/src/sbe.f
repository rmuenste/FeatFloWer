...
C
      ...
      IVT2=KVERT(IV2,IEL)
C
c     suche die kleinste element id iel_min, die die Kante
c     (ivt1,ivt2) enthält. Wenn das aktuelle element iel > iel_min ist,
c     haben wir die Kante (ivt1,ivt2) schon einmal besucht.
