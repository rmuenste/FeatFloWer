...
Ebene::Ebene(const Vector<double>& P, const Vector<double>& e1, const Vector<double>& e2)
{
 this->P=P;
 this->e1=e1/abs(e1);
 this->e2=e2/abs(e2);
...
void Ebene::schneideKugel (Vector<double> O, double r)
{
 double a;
 double Pe1=P*e1;
...
double Ebene::Abstand (Vector<double> R)
{
  // Voraussetzung |n|=1 !
...
void Ebene::binWrite (ofstream &os)
{
...
void Ebene::binRead (ifstream &is)
{
 char svd=sizeof (Vector<double>);
 is.read ((char *) &P, svd);
 is.read ((char *) &e1, svd);
