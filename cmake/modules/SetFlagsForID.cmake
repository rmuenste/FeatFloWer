...
IF(Q2P1_BUILD_ID STREQUAL "epyc2-linux-gcc-release")
  SET(CMAKE_BUILD_TYPE "Release")
  SET(CXX_FLAGS_FC -g -march=haswell)
  SET(Fortran_FLAGS -g -march=haswell -mavx2 -finit-local-zero -ffixed-line-length-none -ffree-line-length-none -fallow-argument-mismatch -Wall -cpp)
  SET(Q2P1_BUILD_ID_FOUND true)
ENDIF()
