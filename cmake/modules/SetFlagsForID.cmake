...
IF(Q2P1_BUILD_ID STREQUAL "broadwell-linux-gcc-release")
  ...
  SET(Fortran_FLAGS -g -march=native -g -finit-local-zero -fallow-argument-mismatch -ffixed-line-length-none -ffree-line-length-none -Wall -cpp)
  SET(Q2P1_BUILD_ID_FOUND true)
ENDIF()
...
IF(Q2P1_BUILD_ID STREQUAL "zen2-linux-gcc-release")
  ...
  SET(Fortran_FLAGS -g -march=znver2 -finit-local-zero -fallow-argument-mismatch -ffixed-line-length-none -ffree-line-length-none -Wall -cpp)
  SET(Q2P1_BUILD_ID_FOUND true)
ENDIF()
...
IF(Q2P1_BUILD_ID STREQUAL "xeon-linux-gcc-debug")
  SET(CMAKE_BUILD_TYPE "Debug")
  SET(CXX_FLAGS_FC)
  SET(Fortran_FLAGS -finit-local-zero -ffixed-line-length-none -fallow-argument-mismatch -ffree-line-length-none -Wall -cpp)
  SET(Q2P1_BUILD_ID_FOUND true)
ENDIF()
