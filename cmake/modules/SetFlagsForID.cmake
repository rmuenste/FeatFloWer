...
IF(Q2P1_BUILD_ID STREQUAL "phenomIIx4-linux-gcc-release")
  ...
  SET(Fortran_FLAGS -march=native -finit-local-zero -ffixed-line-length-none -ffree-line-length-none -Wall)
  SET(Q2P1_BUILD_ID_FOUND true)
ENDIF()
...
IF(Q2P1_BUILD_ID STREQUAL "xeon-linux-gcc-debug")
  SET(CMAKE_BUILD_TYPE "Debug")
  SET(CXX_FLAGS_FC -std=c++11)
  SET(Fortran_FLAGS -finit-local-zero -ffixed-line-length-none -ffree-line-length-none -Wall)
  SET(Q2P1_BUILD_ID_FOUND true)
ENDIF()
