...
IF(Q2P1_BUILD_ID STREQUAL "nehalem-linux-intel-release")
  ...
  SET(FF_C_FLAGS -xhost -funroll-loops -fp-model precise -no-prec-div)
...
IF(Q2P1_BUILD_ID STREQUAL "opteronx2-linux-intel-release")
  SET(CMAKE_BUILD_TYPE "Release")
  SET(CXX_FLAGS_FC -xhost -funroll-loops -fp-model precise -no-prec-div)
  SET(Fortran_FLAGS -xhost -funroll-loops -assume underscore -assume  -fp-model precise -no-prec-div -fpp)
  SET(FF_C_FLAGS -xhost -funroll-loops -fp-model precise -no-prec-div)
  SET(Q2P1_BUILD_ID_FOUND true)
ENDIF()
...
IF(Q2P1_BUILD_ID STREQUAL "broadwell-linux-gcc-release")
  SET(CMAKE_BUILD_TYPE "Release")
  SET(CXX_FLAGS_FC -march=native -g)
  SET(Fortran_FLAGS -march=native -g -finit-local-zero -ffixed-line-length-none -ffree-line-length-none -Wall -cpp)
  SET(Q2P1_BUILD_ID_FOUND true)
ENDIF()
