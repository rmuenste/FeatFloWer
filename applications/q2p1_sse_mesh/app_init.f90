subroutine init_q2p1_ext(log_unit)
  ...
  USE def_FEAT
  USE Transport_Q2P1, ONLY : Init_QuadScalar_Structures_sse_mesh, &
...
"  |                                                          SSE-Meshing module                      |"
  ...
  call Init_QuadScalar_Structures_sse_mesh(log_unit)
!   
...
!=====================================================================================
 ...
 IF (myid.eq.0) WRITE(*,*) 'ReadingMesh:'
 call readTriCoarse(CMESH1, mg_mesh)
 IF (myid.eq.0) WRITE(*,*) 'Done!'

 CALL MPI_BARRIER(MPI_COMM_WORLD,IERR)
 
 IF (myid.eq.0) WRITE(*,*) 'RefineMesh!'
