!===============================================================================
! Initialisation for the q2p1_viscometer application (D5.1 numerical viscometer)
!
! Cloned from applications/q2p1_dkt: serial-PE architecture
! (PE_SERIAL_MODE), HardContactAndFluid constraint solver, external
! particles.xyz packing.  The PE bridge symbol commf2c_dkt / the PE setup
! setupDraftKissTumbSerial is inherited deliberately - see the D5.1 case
! spec: its z=0 ground plane is harmless because the viscometer particles
! live at z >= 5, and renaming the PE setup is out of scope.
!===============================================================================
