subroutine init_q2p1_atc(log_unit)
...
END IF
 ...
 !=======================================================================
 !     Set up the rigid body C++ library (PE library)
 !=======================================================================
 processRanks(1) = 0
...
#ifdef HAVE_PE
  if (myid .ne. 0) then
    call commf2c_hashgrid_test(MPI_COMM_WORLD, MPI_Comm_Ex0, myid)
  end if
#endif
