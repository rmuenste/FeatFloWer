subroutine init_q2p1_ext(log_unit)
  ...
  USE def_FEAT
  USE Transport_Q2P1, ONLY : Init_QuadScalar_Structures_sse_PF,Init_operators_sse_PF, &
    InitCond_QuadScalar,ProlongateSolution,InitMeshDeform, InitOperators 
    
  USE Transport_Q1, ONLY : Init_GenLinSc_ALPHA_Q1,InitCond_ALPHA_PF_Q1,GetInterfacePoints_ALPHA_PF_Q1
...
"  |                                                          SSE-FluidDynamics module                |"
  ...
  call Init_QuadScalar_Structures_sse_PF(log_unit)

  bMultiMat = .true.
  call Init_GenLinSc_ALPHA_Q1(log_unit)
  ...
  if (istart.eq.0) then
    ...
    call InitCond_ALPHA_PF_Q1(log_unit)
