...
\begin{itemize}
  ...
  \item USE\_CGAL:BOOL=True USE\_CGAL\_LOCAL:BOOL :  The combination of these options adds the CGAL library, but uses a local install of the library, in this case set also: 
    \begin{itemize}
