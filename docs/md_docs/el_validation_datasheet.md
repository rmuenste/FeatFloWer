...
| validation | kroupa_shear | etaC_phi_sweep_and_dilute_einstein_check | KD - (1+etaP/mu) -> 2.5*phi as phi -> 0 | Frozen field lacks eta_H = Einstein term in dilute limit; kroupa_shear RUNBOOK (jobs 136222-136224) | missing = 0.129/0.264 vs 2.5phi = 0.125/0.250 at phi = 0.05/0.10; contact fraction 18-52% | 3.2e-02 | consistency_check | PASS |
| validation | kroupa_couette | eta_wall_vs_interior_virial_consistency | agreement of two independent estimators | Wall force balance (Kroupa eqs 26-33) vs interior impulse virial; kroupa_couette RUNBOOK (jobs 136253-136256) | +1.8/+3.0/+3.7/+2.2% at phi 0.05-0.30 | 3.7e-02 | 5.0e-02 | PASS |
| validation | kroupa_couette | eta_total_over_mu_vs_KD | 1.139/1.312/1.821/2.751 | Krieger-Dougherty phi_max=0.64; coupled Couette wall balance; kroupa_couette RUNBOOK | 1.034/1.126/1.664/2.936 (-9/-14/-9/+7%); monotone superlinear | 1.4e-01 | 1.5e-01_band | PASS |
| infrastructure | kroupa_couette | newton_pair_closure_with_walls | 0 | Wall-momentum audit extension; residual = PGS iterate-vs-cache truncation exposed by sphere-wall contacts | 3.9e-6_worst (z-dominant; lub-only smoke 2.7e-20) | 3.9e-06_abs | solver_accuracy_footnote | RECORDED |
| infrastructure | non_el_regression | full_suite_build_and_test_sweep | no regressions from branch changes | Stage-6 pre-merge sweep; el_validation_report.md section 8 | ~250 targets build; EL tests 5/5; FBM/PE benchmarks PASS; 2 serial resume smokes verified pre-existing at pe 8b037ae | NA | zero_attributable_regressions | PASS |
