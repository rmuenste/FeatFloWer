...
| d1_metrology | e1_l3_dt0p5 | E1 dt ladder point: peak vs Table II at L3, dt=0.5ms | -0.03599 m/s | ten_cate_piv.pdf Table II p.4018 | -0.03499 m/s; halving dt recovered 0.43pp of the -3.19% deficit -> temporal term at dt=1ms ~0.6-0.9pp, bulk (-2.3 to -2.6pp) is spatial/other; L4 run is the discriminator | -0.0276 | dt_ladder | RECORDED |
| d1_metrology | e4_l4_dt0p5 | E4 dt ladder point: peak vs Table II at L4, dt=0.5ms | -0.12224 m/s | ten_cate_piv.pdf Table II p.4018 | -0.12120 m/s; halving dt recovered 0.71pp (-1.56 -> -0.85%); first-order reading: T(1ms)~1.4pp, spatial residual at L4 ~-0.1pp; RMS-vs-PIV worsening is the early-phase time-origin artifact, curves agree <1% throughout settling | -0.0085 | dt_ladder | RECORDED |
| d1_metrology | dt_order | temporal-order evidence from dt halving (E4 L4 +0.71pp, E1 L3 +0.43pp recovered) | second-order (CN nominal) | scheme nominal order | shifts consistent with a first-order coupling term (FBM interface + explicit CFD-PE staggering degrading nominal CN); dt=0.25ms point would pin the order | n/a | physics_finding | RECORDED |
