...
| 4 | `docs/md_docs/dns_practitioners_guide.md` v2.2 | the distilled rules: D/h, dt, force noise floor, near-contact crossover, contact parameters, reference discipline, array drag law, job costs | v2.3, 2026-09-10 (§12 Fritz + segmented restarts, §13 ellipsoids) |
