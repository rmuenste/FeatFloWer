...
| 4 | `docs/md_docs/dns_practitioners_guide.md` v2.2 | the distilled rules: D/h, dt, force noise floor, near-contact crossover, contact parameters, reference discipline, array drag law, job costs | 2026-08-18; lacks Fritz, ellipsoids, restart-dump fixes (this file covers them) |
