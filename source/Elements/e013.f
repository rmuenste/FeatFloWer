...
C
      ...
      DHELP(1,2,ICUBP0)= 
     *Q8*(-1D0+2D0*X1)*X2*(1D0-X2)*X3*(1D0-X3)
      DHELP(2,2,ICUBP0)= 
     *Q8*(1D0+2D0*X1)*X2*(1D0-X2)*X3*(1D0-X3)
      DHELP(3,2,ICUBP0)= 
     *-Q8*(1D0+2D0*X1)*X2*(1D0+X2)*X3*(1D0-X3)
     ...
     *Q8*(-1D0+2D0*X1)*X2*(1D0+X2)*X3*(1D0+X3)
      DHELP(9,2,ICUBP0)= 
     *-4D0*Q8*X1*X2*(1D0-X2)*X3*(1D0-X3)
      DHELP(10,2,ICUBP0)= 
     *-Q8*(1D0+2D0*X1)*(2D0-2D0*X2**2D0)*X3*(1D0-X3)
      DHELP(11,2,ICUBP0)= 
     *4D0*Q8*X1*X2*(1D0+X2)*X3*(1D0-X3)
      DHELP(12,2,ICUBP0)=
     * -Q8*(-1D0+2D0*X1)*(2D0-2D0*X2**2D0)*X3*(1D0-X3)
      DHELP(13,2,ICUBP0)=
     * -Q8*(-1D0+2D0*X1)*X2*(1D0-X2)*(2D0-2D0*X3**2D0)
      DHELP(14,2,ICUBP0)= 
     *-Q8*(1D0+2D0*X1)*X2*(1D0-X2)*(2D0-2D0*X3**2D0)
      DHELP(15,2,ICUBP0)= 
     *Q8*(1D0+2D0*X1)*X2*(1D0+X2)*(2D0-2D0*X3**2D0)
     ...
     *4D0*Q8*X1*X2*(1D0-X2)*X3*(1D0+X3)
      DHELP(18,2,ICUBP0)= 
     *Q8*(1D0+2D0*X1)*(2D0-2D0*X2**2D0)*X3*(1D0+X3)
      DHELP(19,2,ICUBP0)= -4D0*Q8*X1*X2*(1D0+X2)*X3*(1D0+X3)
      DHELP(20,2,ICUBP0)= 
     *Q8*(-1D0+2D0*X1)*(2D0-2D0*X2**2D0)*X3*(1D0+X3)
      DHELP(21,2,ICUBP0)= 
     *4D0*Q8*X1*(2D0-2D0*X2**2D0)*X3*(1D0-X3)
      DHELP(22,2,ICUBP0)= 
     *4D0*Q8*X1*X2*(1D0-X2)*(2D0-2D0*X3**2D0)
      DHELP(23,2,ICUBP0)=
     * Q8*(1D0+2D0*X1)*(2D0-2D0*X2**2D0)*(2D0-2D0*X3**2D0)
      DHELP(24,2,ICUBP0)= 
     *-4D0*Q8*X1*X2*(1D0+X2)*(2D0-2D0*X3**2D0)
      DHELP(25,2,ICUBP0)= 
     *Q8*(-1D0+2D0*X1)*(2D0-2D0*X2**2D0)*(2D0-2D0*X3**2D0)
     ...
     *-4D0*Q8*X1*(2D0-2D0*X2**2D0)*X3*(1D0+X3)
      DHELP(27,2,ICUBP0)= 
     *-4D0*Q8*X1*(2D0-2D0*X2**2D0)*(2D0-2D0*X3**2D0)

1103  IF (.NOT.BDER(3)) GOTO 1104
      DHELP(1,3,ICUBP0)= 
     *Q8*X1*(1D0-X1)*(-1D0+2D0*X2)*X3*(1D0-X3)
      DHELP(2,3,ICUBP0)= 
     *-Q8*X1*(1D0+X1)*(-1D0+2D0*X2)*X3*(1D0-X3)
      DHELP(3,3,ICUBP0)= 
     *-Q8*X1*(1D0+X1)*(1D0+2D0*X2)*X3*(1D0-X3)
     ...
     *-Q8*X1*(1D0-X1)*(1D0+2D0*X2)*X3*(1D0+X3)
      DHELP(9,3,ICUBP0)= 
     *-Q8*(2D0-2D0*X1**2D0)*(-1D0+2D0*X2)*X3*(1D0-X3)
      DHELP(10,3,ICUBP0)= 
     *4D0*Q8*X1*(1D0+X1)*X2*X3*(1D0-X3)
      DHELP(11,3,ICUBP0)= 
     *-Q8*(2D0-2D0*X1**2D0)*(1D0+2D0*X2)*X3*(1D0-X3)
      DHELP(12,3,ICUBP0)= 
     *-4D0*Q8*X1*(1D0-X1)*X2*X3*(1D0-X3)
      DHELP(13,3,ICUBP0)= 
     *-Q8*X1*(1D0-X1)*(-1D0+2D0*X2)*(2D0-2D0*X3**2D0)
      DHELP(14,3,ICUBP0)= 
     *Q8*X1*(1D0+X1)*(-1D0+2D0*X2)*(2D0-2D0*X3**2D0)
      DHELP(15,3,ICUBP0)= 
     *Q8*X1*(1D0+X1)*(1D0+2D0*X2)*(2D0-2D0*X3**2D0)
     ...
     *4D0*Q8*X1*(1D0-X1)*X2*X3*(1D0+X3)
      DHELP(21,3,ICUBP0)= 
     *4D0*Q8*(2D0-2D0*X1**2D0)*X2*X3*(1D0-X3)
      DHELP(22,3,ICUBP0)= 
     *Q8*(2D0-2D0*X1**2D0)*(-1D0+2D0*X2)*(2D0-2D0*X3**2D0)
      DHELP(23,3,ICUBP0)= 
     *-4D0*Q8*X1*(1D0+X1)*X2*(2D0-2D0*X3**2D0)
      DHELP(24,3,ICUBP0)= 
     *Q8*(2D0-2D0*X1**2D0)*(1D0+2D0*X2)*(2D0-2D0*X3**2D0)
      DHELP(25,3,ICUBP0)= 
     *4D0*Q8*X1*(1D0-X1)*X2*(2D0-2D0*X3**2D0)
     ...
     *-4D0*Q8*(2D0-2D0*X1**2D0)*X2*X3*(1D0+X3)
      DHELP(27,3,ICUBP0)= 
     *-4D0*Q8*(2D0-2D0*X1**2D0)*X2*(2D0-2D0*X3**2D0)
C
1104  IF (.NOT.BDER(4)) GOTO 99999
      DHELP(1,4,ICUBP0)= 
     *Q8*X1*(1D0-X1)*X2*(1D0-X2)*(-1D0+2D0*X3)
      DHELP(2,4,ICUBP0)= 
     *-Q8*X1*(1D0+X1)*X2*(1D0-X2)*(-1D0+2D0*X3)
      DHELP(3,4,ICUBP0)= 
     *Q8*X1*(1D0+X1)*X2*(1D0+X2)*(-1D0+2D0*X3)
     ...
     *-Q8*X1*(1D0-X1)*X2*(1D0+X2)*(1D0+2D0*X3)
      DHELP(9,4,ICUBP0)= 
     *-Q8*(2D0-2D0*X1**2D0)*X2*(1D0-X2)*(-1D0+2D0*X3)
      DHELP(10,4,ICUBP0)= 
     *Q8*X1*(1D0+X1)*(2D0-2D0*X2**2D0)*(-1D0+2D0*X3)
      DHELP(11,4,ICUBP0)= 
     *Q8*(2D0-2D0*X1**2D0)*X2*(1D0+X2)*(-1D0+2D0*X3)
      DHELP(12,4,ICUBP0)= -
     *Q8*X1*(1D0-X1)*(2D0-2D0*X2**2D0)*(-1D0+2D0*X3)
      DHELP(13,4,ICUBP0)= 
     *-4D0*Q8*X1*(1D0-X1)*X2*(1D0-X2)*X3
      DHELP(14,4,ICUBP0)= 
     *4D0*Q8*X1*(1D0+X1)*X2*(1D0-X2)*X3
      DHELP(15,4,ICUBP0)= 
     *-4D0*Q8*X1*(1D0+X1)*X2*(1D0+X2)*X3
     ...
     *-Q8*X1*(1D0-X1)*(2D0-2D0*X2**2D0)*(1D0+2D0*X3)
      DHELP(21,4,ICUBP0)= 
     *Q8*(2D0-2D0*X1**2D0)*(2D0-2D0*X2**2D0)*(-1D0+2D0*X3)
      DHELP(22,4,ICUBP0)= 
     *4D0*Q8*(2D0-2D0*X1**2D0)*X2*(1D0-X2)*X3
      DHELP(23,4,ICUBP0)= 
     *-4D0*Q8*X1*(1D0+X1)*(2D0-2D0*X2**2D0)*X3
      DHELP(24,4,ICUBP0)= 
     *-4D0*Q8*(2D0-2D0*X1**2D0)*X2*(1D0+X2)*X3
      DHELP(25,4,ICUBP0)= 
     *4D0*Q8*X1*(1D0-X1)*(2D0-2D0*X2**2D0)*X3
     ...
     *Q8*(2D0-2D0*X1**2D0)*(2D0-2D0*X2**2D0)*(1D0+2D0*X3)
      DHELP(27,4,ICUBP0)= 
     *-4D0*Q8*(2D0-2D0*X1**2D0)*(2D0-2D0*X2**2D0)*X3
C
99999 END
