...
!************************************************************************
      SUBROUTINE GetSegmentForce(U1,U2,U3,P,ALPHA,KVERT,KAREA,KEDGE,&
                             DCORVG,DVISC,DResForce,ELE,iref)
!************************************************************************
      USE PP3D_MPI, ONLY:myid,showID,COMM_SUMMN
      USE var_QuadScalar, ONLY : myFBM
...
!
!************************************************************************
      SUBROUTINE GetSoosForce(U1,U2,U3,P,ALPHA,KVERT,KAREA,KEDGE,&
                             DCORVG,DVISC,DTrqForce,ELE)
!************************************************************************
      USE PP3D_MPI, ONLY:myid,showID,COMM_SUMMN
