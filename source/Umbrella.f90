...
!     END SUBROUTINE ProlongateCoordinates
    ...
    ! --------------------------------------------------------------
    !
    SUBROUTINE GetElemVol(X,Y,Z,DVOL)
    IMPLICIT NONE
    REAL*8 X(8),Y(8),Z(8),DVOL
    real*8,parameter :: a1=1d0/6d0

    DVOL=A1*((DABS((X(4)-X(1))*(Y(4)-Y(3))*(Z(4)-Z(8))+(Y(4)-Y(1))*  &
          (Z(4)-Z(3))*(X(4)-X(8))+(Z(4)-Z(1))*(X(4)-X(3))*(Y(4)-Y(8))- &
          (X(4)-X(8))*(Y(4)-Y(3))*(Z(4)-Z(1))-(Y(4)-Y(8))*(Z(4)-Z(3))* &
          (X(4)-X(1))-(Z(4)-Z(8))*(X(4)-X(3))*(Y(4)-Y(1))))+       &
          (DABS((X(2)-X(3))*(Y(2)-Y(1))*(Z(2)-Z(6))+(Y(2)-Y(3))*   &
          (Z(2)-Z(1))*(X(2)-X(6))+(Z(2)-Z(3))*(X(2)-X(1))*(Y(2)-Y(6))- &
          (X(2)-X(6))*(Y(2)-Y(1))*(Z(2)-Z(3))-(Y(2)-Y(6))*(Z(2)-Z(1))* &
          (X(2)-X(3))-(Z(2)-Z(6))*(X(2)-X(1))*(Y(2)-Y(3))))+       &
          (DABS((X(5)-X(8))*(Y(5)-Y(6))*(Z(5)-Z(1))+(Y(5)-Y(8))*   &
          (Z(5)-Z(6))*(X(5)-X(1))+(Z(5)-Z(8))*(X(5)-X(6))*(Y(5)-Y(1))- &
          (X(5)-X(1))*(Y(5)-Y(6))*(Z(5)-Z(8))-(Y(5)-Y(1))*(Z(5)-Z(6))* &
          (X(5)-X(8))-(Z(5)-Z(1))*(X(5)-X(6))*(Y(5)-Y(8))))+       &
          (DABS((X(7)-X(6))*(Y(7)-Y(8))*(Z(7)-Z(3))+(Y(7)-Y(6))*   &
          (Z(7)-Z(8))*(X(7)-X(3))+(Z(7)-Z(6))*(X(7)-X(8))*(Y(7)-Y(3))- &
          (X(7)-X(3))*(Y(7)-Y(8))*(Z(7)-Z(6))-(Y(7)-Y(3))*(Z(7)-Z(8))* &
          (X(7)-X(6))-(Z(7)-Z(3))*(X(7)-X(8))*(Y(7)-Y(6))))+       &
          (DABS((X(1)-X(3))*(Y(1)-Y(8))*(Z(1)-Z(6))+(Y(1)-Y(3))*   &
          (Z(1)-Z(8))*(X(1)-X(6))+(Z(1)-Z(3))*(X(1)-X(8))*(Y(1)-Y(6))- &
          (X(1)-X(6))*(Y(1)-Y(8))*(Z(1)-Z(3))-(Y(1)-Y(6))*(Z(1)-Z(8))* &
          (X(1)-X(3))-(Z(1)-Z(6))*(X(1)-X(8))*(Y(1)-Y(3)))))
    
    END SUBROUTINE GetElemVol
