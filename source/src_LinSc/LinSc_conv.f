************************************************************************
      SUBROUTINE RhoCpConvMat_XSE(U1,U2,U3,T,DA,NU,KCOLA,KLDA,KVERT,
     *           KAREA,KEDGE,DCORVG,KADJ,KVERT1,KAREA1,KEDGE1,
...
C
************************************************************************
      SUBROUTINE RhoCpConvMat_Ewikon(U1,U2,U3,DA,NU,KCOLA,KLDA,KVERT,
     *           KAREA,KEDGE,DCORVG,KADJ,KVERT1,KAREA1,KEDGE1,
     *           NEL1,NVT1,NET1,NAT1,ELE)
************************************************************************
*     Discrete convection operator: Q1 elements
...
C
************************************************************************
      SUBROUTINE RhoCpConv_LinSc1(U1,U2,U3,DA,RHO,CP,NU,KCOLA,
     *           KLDA,KVERT,KAREA,KEDGE,KINT,DCORVG,ELE)
************************************************************************
*     Discrete convection operator: Q1 elements
*-----------------------------------------------------------------------
...
C
       DO 240 IDOFE=1,IDFL
        ...
        ELSE
         ...
         AH=HSUMI*HBASJ1
        ENDIF
        DENTRY(JDOFE,IDOFE)=DENTRY(JDOFE,IDOFE) + DDD*OM*AH
240    CONTINUE
230   CONTINUE
C
200   CONTINUE
...
C
************************************************************************
      SUBROUTINE RhoCpConv_LinSc2(U1,U2,U3,DA,RHO,CP,NU,KCOLA,KLDA,
     *           KVERT,KAREA,KEDGE,DCORVG,KADJ,KVERT1,KAREA1,KEDGE1,
     *           NEL1,NVT1,NET1,NAT1,ELE)
************************************************************************
*     Discrete convection operator: Q1 elements
*-----------------------------------------------------------------------
