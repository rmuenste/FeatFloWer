...
! 
integer, parameter, public :: FBM_FULLY_DYNAMIC       = 1 
! 
integer, parameter, public :: FBMD_FULLY_DYNAMIC      =-1 
! 
integer, parameter, public :: FBM_STATIC              = 2 
! 
integer, parameter, public :: FBMD_STATIC             =-2 
! 
integer, parameter, public :: FBM_STATIC_COMPLEMENT   = 3 
! 
integer, parameter, public :: FBMD_STATIC_COMPLEMENT  =-3 
! 
integer, parameter, public :: FBM_ROTATIONAL          = 4 
! 
integer, parameter, public :: FBMD_ROTATIONAL         =-4 
! 
...
! local variables
real*8 :: dist_sign, d_temp
integer :: iP, iaux, ipc, isin, idynType
...
do ip = 1,myFBM%nParticles
  ...
  if(idynType == FBM_FULLY_DYNAMIC)then
  ...
  elseif(idynType == FBMD_FULLY_DYNAMIC)then

    ! start fbm and distance calculation
    call isinelementid(x,y,z,ipc,isin)
  ...
  elseif(idynType == FBM_STATIC)then

  elseif(idynType == FBM_STATIC_COMPLEMENT)then

    call fbmaux_GetFictKnprInverse(x,y,z, px, py, pz, ipc, inpr, dist)
...
end subroutine fbmaux_GetFictKnpr
!
!-----------------------------------------------------------
!
subroutine fbmaux_GetFictKnprInverse(x,y,z, px, py, pz, ipc, inpr, dist)
...
end subroutine fbmaux_GetFictKnprInverse
!
!-----------------------------------------------------------
!
...
end subroutine fbmaux_GetFictKnprRot
!
!****************************************************************************  
!
