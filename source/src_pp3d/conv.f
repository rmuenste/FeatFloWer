************************************************************************
      SUBROUTINE CONVDG(U1,U2,U3,DRHO,DA,NA,KCOLA,KLDA,KVERT,KAREA, 
...
C
       DO 240 IDOFE=1,IDFL
        ...
        ELSE
         ...
         AH=HSUMI*HBASJ1
        ENDIF
        DENTRY(JDOFE,IDOFE)=DENTRY(JDOFE,IDOFE)+RHO*OM*AH
240    CONTINUE
230   CONTINUE
C
200   CONTINUE
...
C
************************************************************************
      SUBROUTINE CONVNP(U1,U2,U3,DRHO,DA,NA,KCOLA,KLDA,KVERT,KAREA, 
     *                  KEDGE,KINT,DCORVG,ELE)
************************************************************************
